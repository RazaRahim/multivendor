...
public class buyersignup extends AppCompatActivity {
    ...
    private HashMap<String, buyermodel> buyerMap = new HashMap<>();
    String imgUrl;
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (username.getText().length() == 0) {
                    ...
                    Toast.makeText(buyersignup.this, "Select image", Toast.LENGTH_SHORT).show();
//                    CommonUtils.showToast("Select image");
    ...
    private void checkUser() {
        if (buyerMap.containsKey(phone.getText().toString())) {
            Toast.makeText(this, "Phone No already taken\nPlease login", Toast.LENGTH_SHORT).show();
//            CommonUtils.showToast("Username already taken\nPlease login");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_CHOOSE && resultCode == RESULT_OK) {
            ...
            CompressImage compressImage = new CompressImage(buyersignup.this);
            Glide.with(buyersignup.this).load(mSelected.get(0)).into(image);
//            try {
...
//            }
    ...
    private void registerUser() {
        ...
        final buyermodel model = new buyermodel(
        ...
        mDatabase.child("Buyer").child(phone.getText().toString()).setValue(model).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                SharedPrefs.setBuyermodel(model,buyersignup.this);
                wholeLayout.setVisibility(View.GONE);
                Toast.makeText(buyersignup.this, "Successfully registered", Toast.LENGTH_SHORT).show();
//                CommonUtils.showToast("Successfully registered");
                SharedPrefs.setLoggedInAs("Buyer",buyersignup.this);
                startmainactivity();
    ...
    private void startmainactivity() {
        startActivity(new Intent(buyersignup.this, LoginActivity.class));
        finish();
